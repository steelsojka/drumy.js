...
function(a){this.output.gain.value=a;return this};b.prototype.setName=function(a){this.name=a;return this};b.prototype.trigger=function(a){var b,c,d,e;e=this.voices;c=0;for(d=e.length;c<d;c++)b=e[c],g(b,a);return this};b.prototype.destroy=function(){var a,b,c,d;d=this.voices;b=0;for(c=d.length;b<c;b++)a=d[b],a.destroy()};e.Pad=b;null!=Drumy.Event&&Drumy.Event.register(Drumy.Pad)}).call(this);
(function(){var g,i;g=function(a,b){var c;c=new XMLHttpRequest;c.open("GET",a);c.responseType="arraybuffer";c.onload=b;return c.send()};i=function(a,b){return Math.floor(Math.random()*(b-a+1))+a};var h=function(a,b,c,d,e,g,h,i){this.context=h;this.offset=c;this.callback=i;this.source=h.createBufferSource();this.gainNode=h.createGainNode();this.source.buffer=a;this.source.connect(this.gainNode);this.gainNode.connect(g);this.trigger(b,d,e)};h.prototype.trigger=function(a){this.source.start(this.context.currentTime+
this.offset);this.gainNode.gain.value=a/127;setTimeout(this.destroy.bind(this),1E3*(this.source.buffer.duration+this.offset))};h.prototype.destroy=function(){this.source.disconnect(0);this.gainNode.disconnect(0);this.callback()};var e=Drumy,b=function(a){var b,c,d;null==a&&(a={});this.velocityMax=a.velocityMax||127;this.velocityMin=a.velocityMin||0;this.offset=a.offset||0;this.alternateRate=a.alternateRate||0.25;this.context=a.context;this.alternates=[];this.padOutput=a.padOutput;this.url=a.url||
"";this.gain=a.gain||1;this.output=this.context.createGainNode();this.output.connect(this.padOutput);a.gain&&this.setGain(a.gain);a.url&&this.loadFromUrl(a.url);this.buffer&&this.loadBuffer(this.buffer);if(a.alternates){d=a.alternates;b=0;for(c=d.length;b<c;b++)a=d[b],a.context=this.context,a.padOutput=this.padOutput,this.alternates.push(new Drumy.Voice(a))}};b.prototype.save=function(){var a,b=this.url,c=this.gain,d=this.velocityMin,e=this.velocityMax,g=this.offset,h=this.alternateRate,i,m,k,l;k=
this.alternates;l=[];i=0;for(m=k.length;i<m;i++)a=k[i],l.push(a.save());return{url:b,gain:c,velocityMin:d,velocityMax:e,offset:g,alternateRate:h,alternates:l}};b.prototype.loadFromUrl=function(a,b){var c=this;g(a,function(a){c.context.decodeAudioData(a.currentTarget.response,function(a){c.loadBuffer(a);"function"===typeof b&&b()})});return this};b.prototype.loadBuffer=function(a){this.buffer=Array.isArray(a)?this.context.createBuffer(2,a[0].length,this.context.sampleRate):a;return this};b.prototype.trigger=
function(a){this.emit("sampleStart");Math.random()<this.alternateRate&&0<this.alternates.length?this.alternates[i(0,this.alternates.length-1)].trigger(a):new h(this.buffer,a,this.offset,this.velocityMin,this.velocityMax,this.output,this.context,this.onSampleDestroy.bind(this));return this};b.prototype.onSampleDestroy=function(){return this.emit("sampleEnd")};b.prototype.setVelocityMax=function(a){this.velocityMin<a&&127>=a&&(this.velocityMax=a);return this};b.prototype.setVelocityMin=function(a){0<=
a&&a<this.velocityMax&&(this.velocityMin=a);return this};b.prototype.setGain=function(a){this.output.gain.value=a;return this};b.prototype.setOffset=function(a){this.offset=a;return this};b.prototype.getDuration=function(){return this.buffer.duration};b.prototype.destroy=function(){return this.output.disconnect(0)};e.Voice=b;null!=Drumy.Event&&Drumy.Event.register(Drumy.Voice)}).call(this);
